...
I recently tried CachyOS (w/ both Hyprland and Plasma as my DEs) in an attempt to ditch Windows 11. It was fun, and I really enjoyed the OS, however it just didn't work for me since RDP and certain Programs did not work properly without some issues appearing. So In an attempt to mirror my CachyOS experience on Windows 11, I downloaded these Programs to mimic Hyprland as close as possible.
...
If you know of a way to implement these features, please let me know. I would love to have them.
